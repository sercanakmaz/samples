...
using AspNetBuilerplate.Sample1.Web.Controllers.Results;
using AspNetBuilerplate.Sample1.Web.Models.Account;
...
{
    public class AccountController : Sample1ControllerBase
    {
