...
namespace Serene.Sample1.Default.Entities
{
    using Serenity;
    ...
    [ConnectionKey("Default"), TableName("[mov].[Movie]"), DisplayName("Movie"), InstanceName("Movie"), TwoLevelCached]
